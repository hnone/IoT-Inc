...
class SogliaSensore implements JsonSerializable {
  ...
  private $idSensoreInstallato;
	...
	function __construct($nome, $maggiore, $minore, $idSensoreInstallato) {
		$this->nome = $nome;
  ...
  public function getMaggiore() { return $this->maggiore; }

  public function getMinore() {return $this->minore; }
  ...
  public function setMaggiore($maggiore) { $this->maggiore = $maggiore; }

  public function setMinore($minore) { $this->minore = $minore; }
