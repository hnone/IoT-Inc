...
class TerzaParte implements JsonSerializable {
  ...
  private $email;
	...
	function __construct($nome, $cognome, $email, $tempo, $idCliente) {
		$this->nome = $nome;
  ...
  public function getEmail() { return $this->email; }
	...
	public function getUltimoInvio() { return $this->ultimoInvio; }
  ...
  public function setEmail($email) { $this->email = $email; }
	...
	public function setUltimoInvio($ultimoInvio) { $this->ultimoInvio = $ultimoInvio; }
